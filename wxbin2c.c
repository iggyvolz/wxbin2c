...
//
// syntax:  wxbin2c [-c] [-z] <input_file> <output_file>
//
//          -c    add the "const" keyword to definition
//          -z    terminate the array with a zero (useful for embedded C strings)
//
// examples:
//     wxbin2c -c myimage.png myimage_png.cpp
//     wxbin2c -z sometext.txt sometext_txt.cpp
...
void usage(void)
{
	fprintf(stderr, "usage: wxbin2c [-cz] <input_file> <output_file>\n");
	exit(1);
}
